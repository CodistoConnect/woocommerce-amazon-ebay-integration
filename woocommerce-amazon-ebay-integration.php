 ...
 * Plugin URI: https://woocommerce.com/products/amazon-ebay-integration/
...
define( 'CODISTOCONNECT_VERSION', '1.3.29' );
	...
	public function admin_menu() {
		...
		if ( current_user_can( 'manage_woocommerce' ) ) {
			...
			if ( ! is_multisite() ) {
				...
				$pages[] = add_submenu_page( 'codisto', __( 'Link Listings', 'codisto-linq' ), __( 'Link eBay Listings', 'codisto-linq' ), 'edit_posts', 'codisto-import', array( $this, 'import' ) );
